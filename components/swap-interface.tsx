...
export default function SwapInterface() {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-12 px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-black mb-4">Swap Tokens</h1>
        ...
        <div className="backdrop-blur-xl bg-white/80 border-2 border-white/50 rounded-2xl p-8 shadow-2xl hover:border-[#f85522]/30 transition-all duration-300">
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-3">
              <select
                ...
                className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#f85522] transition-colors bg-white"
              >
              ...
              <input
                ...
                placeholder="0.00"
                className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#f85522] transition-colors"
              />
            </div>
          </div>
          ...
          <div className="flex justify-center mb-6">
            <button
              ...
              className="p-3 bg-[#f85522] text-white rounded-full hover:bg-[#e64a1a] transition-all duration-300 transform hover:scale-110 shadow-lg"
            >
          ...
          {/* To Token */}
          <div className="mb-6">
            <label className="block text-sm font-semibold text-black mb-3">To</label>
            <div className="flex gap-3">
              <select
                value={swap.toToken}
                onChange={(e) =>
